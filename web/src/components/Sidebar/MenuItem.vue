...
const iconPaths = {
  ...
  start: 'M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h8a2 2 0 002-2V8a2 2 0 00-2-2H8a2 2 0 00-2 2v4a2 2 0 002 2z',
  ...
  connect: 'M8 9l3 3-3 3m5 0h3m-5-8h.01M5 21h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z',
  ...
  test: 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z',
...
const iconPath = computed(() => {
  return iconPaths[props.icon] || iconPaths.edit // fallback to edit icon
})
</script> 